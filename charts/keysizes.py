...
def insert():
    ...
    plt.title("Insertion Performance with Varying Key Size")
    plt.legend(charts)
    plt.xticks(xs, xs)
    plt.grid(axis='x', linestyle='--')
    plt.savefig("figs/key_insert_thru.png")
...
def find():
    ...
    plt.xlabel("Threads")
    plt.ylabel("Throughput (MOps/sec)")
    plt.title("Find Performance with Varying Key Size")
    plt.legend(charts)
    plt.xticks(xs, xs)
    plt.grid(axis='x', linestyle='--')
    plt.savefig("figs/key_find_thru.png")
